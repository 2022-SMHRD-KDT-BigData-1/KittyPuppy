...
<div class="container">
    ...
    <div class = ''>
        ...
        <div class = 'navbar text-center banner'>
            <a href = ''><i class = "bi bi-phone footer"></i></a>
            <a href = ''><i class = "bi bi-megaphone footer"></i></a>
            <a href = ''><i class = "bi bi-geo-alt footer"></i></a>
            <a href = ''><i class = "bi bi-person footer"></i></a>
            <a href = ''><i class = "bi bi-chat-dots footer"></i></a>
        </div>
    </div>
