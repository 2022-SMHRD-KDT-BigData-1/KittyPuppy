...
public class FrontController extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		map.put("/FeedCountCon.do", new FeedCountCon());
		map.put("/FeedSearchResultCountCon.do", new FeedSearchResultCountCon());
		...
		map.put("/FeedLikeCheckCon.do",new FeedLikeCheckCon());
		map.put("/FollowerShowCon.do", new FollowerShowCon());
		...
		map.put("/LostCommentCountCon.do", new LostCommentCountCon());
		...
		map.put("/DMDeleteCon.do", new DMDeleteCon());
		map.put("/DMDeleteAllCon.do", new DMDeleteAllCon());
		map.put("/LostCommentCntCon.do", new LostCommentCntCon());
